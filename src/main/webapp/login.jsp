				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input id = "name" type="text"  name="name" class="text" value="name" maxlength="20"/>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<input id = "password" type="password" name="password" class="text" value="password" maxlength="20" autocomplete="off"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<input type="submit" class="loginButton" onclick="doLogin()" value="登录">
							</td>
						</tr>
